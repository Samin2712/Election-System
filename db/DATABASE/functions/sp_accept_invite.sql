CREATE OR REPLACE FUNCTION public.sp_accept_invite(p_token character varying, p_user_id bigint)
 RETURNS TABLE(out_organization_id bigint, out_organization_name text, out_role_name text)
 LANGUAGE plpgsql
AS $function$
DECLARE
    v_invite_id INTEGER;
