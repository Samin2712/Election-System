...
-- Fix: Disable audit triggers during org deletion to prevent FK violations
-- The cascade delete fires audit triggers that try to INSERT into audit_logs
-- referencing the organization being deleted, causing FK violation.
