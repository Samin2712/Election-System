CREATE OR REPLACE FUNCTION public.sp_approve_join_request(p_request_id integer, p_admin_user_id bigint)
 RETURNS TABLE(out_user_id bigint, out_username character varying, out_email citext, out_organization_name character varying)
 LANGUAGE plpgsql
AS $function$
DECLARE
    v_org_id BIGINT;
